...
static CGFloat SWITCH_FOCUS_PICTURE_INTERVAL = 3.0; //切换间隔时间

static NSInteger ITEM_NUM = 4;
	...
	if ((self=[super initWithFrame:rect])) {
        ...
        scrollView.delegate = self;
            for (int i=0; i<pageCount; i++) {
                ...
                [imgView setFrame:CGRectMake(viewSize.size.width*i, 0,viewSize.size.width, viewSize.size.height-35)];
                imgView.tag=i;
        ...
        [noteView setBackgroundColor:[UIColor colorWithRed:0.6 green:0.6 blue:0.6 alpha:0.9]];
        
        float pageControlWidth=(ITEM_NUM-2)*10.0f+40.f;
        float pagecontrolHeight=20.0f;
        pageControl=[[UIPageControl alloc]initWithFrame:CGRectMake((self.frame.size.width-pageControlWidth-30),6, pageControlWidth, pagecontrolHeight)];
